/*
codeunit 50051 CustomLayoutReportingCS
{
    ...
    begin
        ...
        exit(GetSelectionFilterForStudent(Customer));

    end;

    procedure GetSelectionFilterForStudent(var Student: Record "Student Master-CS"): Text
    var
        RecRef: RecordRef;
    begin
        RecRef.GetTable(Student);
        exit(GetSelectionFilter(RecRef, Student.FieldNo("No.")));
    end;
    ...
    var
        EntryTempBlob: Codeunit "TempBlob Test";
    ...
    begin
        ...
        if ReportDataRecordRef.FindSet then begin
            repeat
                ...
                //Error('%1', CustomReportSelection.Count);//SN
    ...
    begin
        ...
        //Error('%1..%2...%3..%4..%5', DataRecordRef, SourceJoinFieldName, DataRecordJoinTable, IteratorTableFieldName, DataItemTableSameAsIterator);
    ...
    var
        DataTypeManagement: Codeunit "Data Type Management";
    //Stu : Record "Student Master-CS"
    begin
        //Error('%1..%2', TableRecordRef.Number, NameFieldRef);
        case TableRecordRef.Number of
            DATABASE::"Student Master-CS",
            DATABASE::Vendor:
                begin
                    DataTypeManagement.FindFieldByName(TableRecordRef, NameFieldRef, 'Student Name');
                    exit(true);
                end;
            else
                exit(false);
    ...
    begin
        ...
        AcctTypeFieldRef := ReportDataRecordRef.Field(2);
        DataRecordJoinTable := DATABASE::"Student Master-CS";
    ...
    var
        CustomerLayoutStatement: Codeunit StudentLayoutStatementcs;
    begin
