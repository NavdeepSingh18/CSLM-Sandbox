page 50050 "Std Rotation Audit View"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Student Master-CS";
    Caption = 'Students Rotation Audit View';
    PromotedActionCategories = 'New,Process,Navigate,FM1/IM1 Rotation,Pediatrics,Obstetrics/Gynecology,Surgery,Family Medicine,Internal Medicine,Psychiatric';
    Editable = false;
    InsertAllowed = false;
    DeleteAllowed = false;
    ModifyAllowed = false;
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("Psychiatric Incomplete Students")
            {
                ApplicationArea = All;
                Caption = 'Incomplete Students';
                Image = CollapseAll;
                ...
                trigger OnAction()
                begin
                    SelectedOptionTxt := 'Psychiatric Incompleted Students';
                    CurrPage.Update(false);
                    MarkStudentsComplete_InComplete(PsychiatricSubjects, false, PsychiatricWeeks);
                end;
            }
            action("Psychiatric Completed Students")
            {
                ApplicationArea = All;
                Caption = 'Completed Students';
                Image = Completed;
                ...
                trigger OnAction()
                begin
                    SelectedOptionTxt := 'Psychiatric Completed Students';
                    CurrPage.Update(false);
    ...
    begin
        ...
        // RSH.SetFilter("Start Date", '>=%1', WorkDate());//CSPL-00307-RTP
