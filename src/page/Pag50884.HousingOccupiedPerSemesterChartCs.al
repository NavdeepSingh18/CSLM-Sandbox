page 50884 "Housing Occupy Per Semester"
{
    Caption = 'Housing Occupied per Semester Chart';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            ...
            //         HousingAppln.SetRange(HousingAppln.Semester, point.XValueString());
    ...
    var
        ...
        housingOccpancy: Query "Housing Occupancy per Semester";
    ...
    begin
        ...
        while housingOccpancy.Read() do begin
            Rec.AddColumn(Format(housingOccpancy.Semester));
