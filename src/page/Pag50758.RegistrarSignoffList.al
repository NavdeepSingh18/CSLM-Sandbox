page 50758 "Registrar Sign off List"
{
    Caption = 'Pending Registrar Sign off List';
    ...
    SourceTableView = SORTING("No.") ORDER(Ascending) where("OLR Completed" = filter(true), "Student Group" = filter("On-Ground Check-In Completed"), "Registrar Signoff" = filter(false));
    ...
    //                     IF CONFIRM(Text009Lbl, FALSE) THEN BEGIN
    //                         IF StudentMasterCS.FindSet() then
    //                             repeat
    //                                 if StudentMasterCS."Student Group" = StudentMasterCS."Student Group"::"On-Ground Check-In Completed" then begin
    //                                     HoldChecks(StudentMasterCS);
    //                                     StudentMasterCS.validate("Registrar Signoff", true);
    //                                     StudentMasterCS.validate(Status, StudentStatusMangCod.RegistrarSignoff
    //                                     (StudentMasterCS."No.", StudentMasterCS.Status, StudentMasterCS.Semester,
    //                                     StudentMasterCS."Global Dimension 1 Code"));

    //                                     StudentMasterCS.Modify();
    //                                     //Report.Run(Report::"Student Subject Mapping", false, false, StudentMasterCS);
    //                                     StudentMappingReport.SetTableView(StudentMasterCS);
    //                                     StudentMappingReport.Setdata(StudentMasterCS);
    ...
    //                         exit;
    //                 end else
    //                     IF CONFIRM(Text010Lbl, FALSE, "No.") THEN BEGIN
    //                         if "Student Group" = "Student Group"::"On-Ground Check-In Completed" then begin
    //                             HoldChecks(Rec);
    //                             Validate("Registrar Signoff", true);
    //                             Validate(Status, StudentStatusMangCod.RegistrarSignoff("No.", Status, Semester, "Global Dimension 1 Code"));
    //                             Modify();
    //                             StudentMappingReport.SetTableView(Rec);
    //                             StudentMappingReport.Setdata(Rec);
    //                             StudentMappingReport.UseRequestPage(false);
    //                             StudentMappingReport.Run();
    //                             //Report.Run(Report::"Student Subject Mapping", false, false, Rec);
    //                         end else
    //                             Error('Student Group must be On-Ground Check-In Completed');
    //                         Message(Text012Lbl);
    //                         CurrPage.Update();
