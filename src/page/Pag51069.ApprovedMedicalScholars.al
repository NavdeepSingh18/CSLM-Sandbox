page 51069 "Approved Medical Scholars"
{

    ApplicationArea = All;
    Caption = 'Approved Medical Scholars Program List';
    PageType = List;
    SourceTable = "Medical Scholar Program";
    UsageCategory = Lists;
    SourceTableView = Sorting("Application Date") Order(descending) where("Application Status" = filter(Approved));
        ...
        area(Processing)
        {
            action("Interview Confirmed")
            {
                ...
                begin
                    ...
                    RecHead.Validate("Application Status", Rec."Application Status"::"Interview Confirmed");
                    RecHead.Modify();
                    Message('Document %1 Interview is Confirmed', RecHead."Application No");
