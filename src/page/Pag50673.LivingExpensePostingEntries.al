page 50673 "Living Expense Posting Entries"
{
    ...
    SourceTableView = where("View Part" = filter("Posting Entries" | "Application Entries" | "Past Application" | "Housing Application"));
    InsertAllowed = false;
    DeleteAllowed = false;
    Editable = true;
    layout
