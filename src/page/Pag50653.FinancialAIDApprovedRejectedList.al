page 50653 "FinancialAIDApprovRejectList"
{

    PageType = List;
    SourceTable = "Financial AID";
    Caption = 'Approved/Rejected Financial Aid Applications';
    ApplicationArea = All;
    UsageCategory = Lists;
    Editable = false;
    CardPageId = "Apprvd Rejected Financial AID";
    SourceTableView = Where(Status = filter(Approved | Rejected), "Type" = filter("Financial Aid"));
