page 50949 "Financial AID Pending Listpart"
{

    PageType = ListPart;
    SourceTable = "Financial AID";
    Caption = 'Pending Financial Aid Applications LP';
    ModifyAllowed = false;
    UsageCategory = None;
    Editable = false;
    CardPageId = "Financial AID";
    SourceTableView = Where(Status = filter("Pending for Approval"), "Type" = filter("Financial Aid"));
