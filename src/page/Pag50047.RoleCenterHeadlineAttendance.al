page 50047 RoleCenterHeadlineAttendance
{
    ...
    begin
        ...
        if LeavesApvls.FindSet() then begin
            ...
            hdl4Txt := 'There are ' + Headlinesmgnt.Emphasize(Format(CountPngCLOAApps)) + ' Pending COA Applications.';
        End Else begin
            hdl4Txt := 'There are No Pending CLOA Applications.';
        end;
        //4 end
    end;
}