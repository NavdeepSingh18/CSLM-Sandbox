page 50531 "Approved Rejected ELOA List"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Student Leave of Absence";
    Caption = 'Approved Rejected ELOA List';
    Editable = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    DeleteAllowed = false;
    CardPageId = "Approved Rejected Leave Card";
    SourceTableView = where("Leave Types" = Filter(ELOA), status = Filter(Approved | Rejected));
    layout
    {
        area(Content)
        {
