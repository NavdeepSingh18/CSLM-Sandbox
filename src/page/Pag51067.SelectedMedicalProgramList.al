page 51067 "Selected Medical Program List"
{

    ApplicationArea = All;
    Caption = 'Selected/ Not Selected Medical Scholar Program List';
    PageType = List;
    SourceTable = "Medical Scholar Program";
    UsageCategory = Lists;
    SourceTableView = Sorting("Application Date") Order(descending) where("Application Status" = filter(Selected | NotSelected));
