page 51037 "Send to Store History SubPage"
{
    caption = 'Send to Store History SubPage';
    PageType = ListPart;
    // ApplicationArea = All;
    ...
    layout
    {
        area(Content)
        {
            repeater("Send to Store History Subpage")
            {
                ...
                field("Remaining Quantity to Issue"; Rec."Remaining Quantity to Issue")
                {
                    ...
                    begin
                        ...
                        Rec.VALIDATE(Rec."Remaining Quantity to Issue");
                    end;
                }
