page 50896 "Approved Rejected Degree Audit"
{
    PageType = List;
    ...
    InsertAllowed = false;
    DeleteAllowed = false;
    CardPageId = "Degree Audit Approved Rejected";
    SourceTable = "Degree Audit";
    DataCaptionFields = "Application No.", "Student Name";
    SourceTableView = sorting("Application No.") order(descending) where("Document Status" = filter(Verified | Rejected));
