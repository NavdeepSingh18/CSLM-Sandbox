page 50541 "Exam Opt Out Pending Approval"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    Insertallowed = false;
    DeleteAllowed = false;
    Caption = 'Exam Opt Out Pending Approval';
    SourceTableView = Where(Status = filter("Pending for Approval"), "Application Type" = filter("Bsic Opt Out"));
