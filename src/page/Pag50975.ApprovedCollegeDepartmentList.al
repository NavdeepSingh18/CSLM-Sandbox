Page 50975 "Approved College Department"
{

    PageType = List;
    SourceTable = "Withdrawal Approvals";
    SourceTableView = where("Type of Withdrawal" = filter("College-Withdrawal"), Status = FILTER(Approved));
    Caption = 'Apprroved College Withdrawal Approvals List';
    ApplicationArea = All;
    ...
    begin
        ...
        WithdrawalDepartmentRec.SetRange("User Name", UserSetupRec."User ID");
        ...
        Rec.FILTERGROUP(2);
        Rec.SetFilter(Rec."Approved for Department", DepartmentName);
        Rec.FILTERGROUP(0);

        //SD-SN-17-Dec-2020 +
        Rec.FilterGroup(3);
        Rec.SetFilter(Rec."Global Dimension 1 Code", StudentsInfoCSCSLM.GetuserSetupInstitudeCode());
        Rec.FilterGroup(5);
        //SD-SN-17-Dec-2020 -
    end;
