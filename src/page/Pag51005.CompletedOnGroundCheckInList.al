page 51005 "Completed On-Ground Check List"
{
    Caption = 'On-Ground Check-In Completed List';
    ...
    SourceTableView = SORTING("No.") ORDER(Ascending) where("OLR Completed" = filter(true), "Student Group" = filter("On-Ground Check-In Completed"));
            ...
            Group(Report)
            {
                action("AUA Student Detail")
                {
                    ...
                    begin
                        ...
                        StudentMasterCS.SetRange(Term, educationsetup."Even/Odd Semester");
                        if StudentMasterCS.FindFirst() then
                            Report.Run(50247, true, false, StudentMasterCS);
                    end;
                }
                action("AICASA Student Detail")
                {
                    ApplicationArea = All;
                    Image = Report;
                    Promoted = true;
                    ...
                    begin
                        educationsetup.Reset();
                        educationsetup.SetRange("Global Dimension 1 Code", '9100');
                        educationsetup.FindFirst();
                        ...
                        StudentMasterCS.SetRange(Term, educationsetup."Even/Odd Semester");
                        if StudentMasterCS.FindFirst() then
                            Report.Run(50248, true, false, StudentMasterCS);
                    end;
                }

                action("AUA Student Subjects Detail")
                {
                    ApplicationArea = All;
                    Image = Report;
                    Promoted = true;
                    ...
                    begin
                        ...
                        StudentMasterCS.SetRange(Term, educationsetup."Even/Odd Semester");
                        if StudentMasterCS.FindFirst() then
                            Report.Run(50249, true, false, StudentMasterCS);
                    end;
                }
                action("AICASA Student Subjects Detail")
                {
                    ApplicationArea = All;
                    Image = Report;
                    Promoted = true;
                    ...
                    begin
                        ...
                        StudentMasterCS.SetRange(Term, educationsetup."Even/Odd Semester");
                        if StudentMasterCS.FindFirst() then
                            Report.Run(50250, true, false, StudentMasterCS);
                    end;
                }
            }
        }
    ...
    begin
        ...
        Rec.setFilter(Status, '<>%1&<>%2&<>%3&<>%4', 'DIS', 'WITH', 'ADWD', 'DEC');
        Rec.FilterGroup(0);
