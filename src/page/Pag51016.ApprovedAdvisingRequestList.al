page 51016 "App. Resch. Advs. Request List"
{
    Caption = 'Approved/ Rescheduled Advising Request List';
    PageType = List;
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("Synch Appointments")
            {
                Caption = 'Sync Appointments';
                ApplicationArea = all;
                Image = Refresh;
                Promoted = true;
                PromotedCategory = Process;
                PromotedIsBig = true;
                PromotedOnly = true;
                Visible = Hide_For_Clinical;
                trigger OnAction()
                var
                    WebServicesFunctionsCS: Codeunit WebServicesFunctionsCSL;

                begin
                    WebServicesFunctionsCS.SynchBookingAppointments();
                    Message('All the appoinments has been synched successfully.');
                end;
            }
