page 50912 "Students opted with PP"
{
    ...
    layout
    {
        area(content)
        {
            ...
            //         StudentMasterCS.SetRange(StudentMasterCS."Payment Plan Applied", true);
    ...
    var
        ...
        HousingOccupanyTxt: Label 'No. of Students opted with Payment Plan';
    ...
    var
        NoofStudentsoptedwithFA: Query "Student Opted with PP";
    ...
    begin
        ...
        if Semester.FindSet() then begin
            repeat
                ...
                NoofStudentsoptedwithFA.setrange(NoofStudentsoptedwithFA.Payment_Plan_Applied, true);
