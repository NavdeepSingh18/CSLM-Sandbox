Page 50974 "Approved Course Department"
{

    PageType = List;
    SourceTable = "Withdrawal Approvals";
    SourceTableView = where("Type of Withdrawal" = filter("Course-Withdrawal"), Status = FILTER(Approved));
    Caption = 'Approved Course Withdrawal Approvals List';
    ApplicationArea = All;
