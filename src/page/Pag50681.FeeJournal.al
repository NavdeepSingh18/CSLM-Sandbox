page 50681 "Fee Journal"
{
    ...
    begin
        ...
        //GenJnlManagement.TemplateSelection(PAGE::"Fee Journal", false, Rec, JnlSelected);//GMCSCOM
    ...
    begin
        if IsSimplePage then begin
            ...
            Rec.SetCurrentKey(Rec."Document No.", Rec."Line No.");
