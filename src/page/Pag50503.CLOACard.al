page 50503 "CLOA Card"
{
            ...
            action("Send for Approval")
            {
                ...
                begin
                    ...
                    If Confirm(Text50000Lbl, True, Rec."Application No.") then begin
                        ...
                        Rec.Modify();
                        Rec.UpdateCLOAApplication(Rec);
                        Rec.PostStudentLeavesApprovalEntries(Rec."Leave Types");
                        // IF Rec."Leave Types" = Rec."Leave Types"::CLOA then
                        //     CLOARequestforApprovalMailtoStudent();
                        CurrPage.Update();
    ...
    begin
        Rec."Leave Types" := Rec."Leave Types"::CLOA;
    end;
