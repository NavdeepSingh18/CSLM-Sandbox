page 50680 "Payment Plan Journal"
{
    ...
    begin
        ...
        // GenJnlManagement.TemplateSelection(PAGE::"Payment Plan Journal", 0, false, Rec, JnlSelected);//GMCSCOM
