page 50522 "SLOA Card"
{
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("Send for Approval")
            {
                ...
                //     //IF DaysCount_lInt > 5 then
                //     //    Error('You can not apply leave more then 5 Days');
                ...
                //         //LeaveofApproval_lPage.SLOARequest();
                //         CurrPage.Close();
    ...
    begin
        Rec."Leave Types" := Rec."Leave Types"::SLOA;
    end;
