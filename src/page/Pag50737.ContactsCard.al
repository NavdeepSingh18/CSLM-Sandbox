page 50737 "Contacts Card"
{
        ...
        area(Content)
        {
            group(General)
            {
                ...
                group(ContactDetails)
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        ToolTip = 'Specifies the contact''s Extension number.';
                    }
    ...
    begin
        ...
        BusinessContactRelation.SetRange("Relation Type", Rec."Initiated Source Type");
        BusinessContactRelation.SetRange("No.", Rec."Initiated Source No.");
        BusinessContactRelation.SetRange("Contact No.", Rec."No.");
        if not BusinessContactRelation.FindFirst() then begin
            BusinessContactRelation."Relation Type" := Rec."Initiated Source Type";
            BusinessContactRelation."No." := Rec."Initiated Source No.";
            BusinessContactRelation.Validate("Contact No.", Rec."No.");
            BusinessContactRelation.Insert();
        end;
