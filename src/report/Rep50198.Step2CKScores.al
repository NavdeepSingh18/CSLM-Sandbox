report 50198 "Step 2 CK Scores"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Student No.") where("Score Type" = filter("STEP 2 CK"));
            ...
            begin
                ...
                TempExcelBuffer.AddColumn('Pass/Fill', false, '', True, false, false, '', TempExcelBuffer."Cell Type"::Text);
            ...
            var
                ...
                CourseFilter: Text;
            begin
                IF "Student Subject Exam".Result = "Student Subject Exam".Result::" " then
                    CurrReport.Skip();
                Code1 := '';
                SemesterFilter := '';
                StudentNoFilter := '';
                ...
                IF "Student Subject Exam".GetFilter("Global Dimension 1 Code") = '9000' then begin
                    CourseMaster.Reset();
                    CourseMaster.SetRange("Global Dimension 1 Code", "Student Subject Exam"."Global Dimension 1 Code");
                    ...
                    StudentMaster.SetRange("Original Student No.", "Student Subject Exam"."Original Student No.");
                    StudentMaster.SetFilter("Course Code", CourseFilter);
                    IF StudentMaster.FindLast() then;
                end;
                IF "Student Subject Exam".GetFilter("Global Dimension 1 Code") = '9100' then begin
                    IF StudentMaster.Get("Student Subject Exam"."Student No.") then;
                end;
    ...
    begin
        ...
        if InstituteCode <> '9000' then
            Error('This Institude does not have CCSE exam.');
    ...
    var
        ...
        StudentList: Label 'Step 2 CK Scores';
        ExcelFileName: Label 'Step 2 CK Scores_%1_%2';
