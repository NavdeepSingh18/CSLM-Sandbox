...
report 50177 "Cheque Print Acc2742"
{
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Check Print Acc2742';
    ApplicationArea = all;
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/Cheque Print Acc2742.rdl';
    ...
    dataset
    {
        dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
        {
            ...
            { }
            column(CompInfo_Name; Uppercase(CompInfo.Name))
            { }
            ...
            begin
                IF ("Bank Account No." = 'BANK0002') then
                    error('You can not print cheque for Bank Account No:"BANK0002"');
                ...
                BottomNamePrint := UpperCASE(InstituteName + ' /C/O ' + CompInfo.Name);
                InitTextVariable();
