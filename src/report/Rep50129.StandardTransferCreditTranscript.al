report 50129 "Standard Tran Cre Transcript"
{
    Caption = 'Standard Transfer Credit Transcript';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/AUA College of Medicine Official Transcript (Transfer Credit, Legacy Data).rdl';
        ...
        dataitem("Student Master-CS"; "Student Master-CS")
        {
            ...
            begin
                ...
                If StudentNo_gTxt <> "Student Master-CS"."Original Student No." then begin
                    ...
                    EntryNo := EntryNo + 1;
                    TempRecord1."Entry No" := EntryNo;
                    TempRecord1.Field38 := 'Earned Credits: ';// + ' ' + Format(GrandPoint + GrandPoint1) + '  ' + 'Final GPA :' + ' ' + Format(Round((GrandPoint + GrandPoint1) / (GrandGPA)))
                    // TempRecord1.Field39 := 'Final GPA: ';
                    TempRecord1.Field23 := TotalCreditEarned;
                    // IF GrandGPA <> 0 then
                    //     TempRecord1.Field24 := Round((GrandPoint + GrandPoint1) / GrandGPA)
                    // Else
                    //     TempRecord1.Field24 := 0;
