report 50195 "CCSEScores"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Student No.") where("Score Type" = filter(CCSE));
            ...
            begin
                ...
                TempExcelBuffer.AddColumn('E-mail Address', false, '', True, false, false, '', TempExcelBuffer."Cell Type"::Text);
            ...
            begin
                ...
                TempExcelBuffer.AddColumn(StudentMaster."E-Mail Address", false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
    ...
    var
        ...
        StudentList: Label 'CCSE Scores';
        ExcelFileName: Label 'CCSE Scores_%1_%2';
