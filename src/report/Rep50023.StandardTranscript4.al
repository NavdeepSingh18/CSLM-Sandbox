report 50023 StandardTranscript4
{
    Caption = 'Standard Transcript';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/StandardTranscript4.rdl';
    ...
    dataset
    {
        ...
        dataitem(TempRecord; "Unit Master-CS")
        {
    ...
    var
        ...
        TempRecord1: Record "Unit Master-CS";
        TempRecordTemp: Record "Unit Master-CS";
