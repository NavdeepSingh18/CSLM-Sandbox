report 50204 "AICASA ASHS Degree"
{
    Caption = 'AICASA Associate of Science in Health Science Degree';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/AICASA ASHS Degree.rdl';
        ...
        dataitem("Student Degree"; "Student Degree")
        {
            ...
            begin
                ...
                IF StudentDegree.FindFirst() then begin
                    IF StudentDegree."Degree Code" <> 'PM' then
