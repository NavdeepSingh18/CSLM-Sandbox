report 50179 "Sem 4 Student Not Registered"
{
    Caption = 'Semester 4 Students That Have Not Registered';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/Semester 4 Students That Have Not Registered.rdlc';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("No.") where("OLR Completed" = filter(false));
