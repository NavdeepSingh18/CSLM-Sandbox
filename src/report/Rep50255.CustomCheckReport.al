// report 50255 Customheck
// {
//     DefaultLayout = RDLC;
//     // RDLCLayout = './Check.rdlc';
//     Caption = 'Check';
//     ProcessingOnly = true;//CSPL-00307
...
//                     trigger OnAfterGetRecord()
//                     begin
//                         IF GenJnlLine."Bal. Account No." = 'BANK0002' THEN
//                             Bank0002 := true
//                         else
//                             Bank0002 := false;
//                         VarDocNo := GenJnlLine."Document No.";
...
//                             IF GenJnlLine3."Posting No. Series" = '' then
...
//     var
//         Repor50257: Report "ChequePrintPaymentJrnl Acc2742";
//         Repor50256: Report "ChequePrintAcc0438 PaymentJrnl";
//         Rec81: Record "Gen. Journal Line";
//     begin
//         Rec81.Reset();
//         Rec81.SetRange("Document No.", VarDocNo);
//         Rec81.SetRange("Check Printed", true);
//         Rec81.FindFirst();

//         // IF BANK0002 then begin
//         Repor50256.UseRequestPage(false);
//         Repor50256.SetTableView(Rec81);
//         Repor50256.Run();
//         // end;
//         //else begin
//         //     Repor50257.UseRequestPage(false);
//         //     Repor50257.SetTableView(Rec81);
//         //     Repor50257.Run();
//         // end;
//         // Report.RUN(50256, false, false, GenJnlLine)
//         // else
//         // Report.RUN(50257, false, false, GenJnlLine);
//     end;
