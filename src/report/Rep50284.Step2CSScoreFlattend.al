report 50284 Step2CSScoreFlattened
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Step2 CS Scores Flattened';
    ProcessingOnly = true;
    dataset
    {
    ...
    begin
        ...
        TempExcelBuffer.CreateNewBook('Step 2 CS Score Flattened');
        TempExcelBuffer.WriteSheet('Step 2 CS Score Flattened', CompanyName, UserId);
        TempExcelBuffer.CloseBook();
        TempExcelBuffer.SetFriendlyFilename(StrSubstNo('Step 2 CS Score Flattened_%1_%2', CurrentDateTime, UserId));
