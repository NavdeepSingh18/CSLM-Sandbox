report 50186 "Cohort New Version"
{
    Caption = 'Cohort New Version';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/Cohort New Version.rdlc';
    ...
    dataset
    {
        dataitem("Student Master-CS"; "Student Master-CS")
        {
            ...
            { }
            column(Residency_Year; '')
            { }
            column(Residency_Status; '')
            { }
            column(Placement_Type; '')
            { }
            column(Residency_Specialty; '')
            { }
            column(Hospital; '')
            { }
            column(Hospital_City; '')
            { }
            column(Hospital_State; '')
            { }
            column(Affiliated_Hospital; '')
            { }
            column(Match_Attempt; '')
            { }
            column(Match_Order; '')
            { }
