report 50002 StandardTranscript1
{
    Caption = 'Standard Transcript';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/StandardTranscript1.rdl';
    ...
    dataset
    {
                                    ...
                                    repeat
                                        ...
                                        If PassingGrade_gRec.FindFirst() then begin
                                            ...
                                            If PassingGrade_gRec."BSIC Grading Calc." then              //CSPL-00116
                                                TotalCreditEarned += MainStudentSubject_gRec1."Credits Attempt";
        ...
        dataitem(TempRecord; "Enquiry Source-CS")
        {
    ...
    var
        ...
        TempRecord1: Record "Enquiry Source-CS";
        TempRecordTemp: Record "Enquiry Source-CS";
