report 50112 "Step 2 CS Scores"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Student No.") where("Score Type" = filter("STEP 2 CS"));
    ...
    var
        ...
        StudentList: Label 'Step 2 CS Scores';
        ExcelFileName: Label 'Step 2 CS Scores_%1_%2';
