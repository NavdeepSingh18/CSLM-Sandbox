report 50206 "AUA Master of Health Science"
{
    Caption = 'AUA Master of Health Science Degree';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/AUA Master of Health Science Degree.rdl';
    ...
    dataset
    {
        dataitem("Student Degree"; "Student Degree")
        {
            ...
            { }
            column(Honors_Name; RecStudentHonor."Honors Name")
            { }
            ...
            begin
                ...
                IF StudentDegree.FindFirst() then begin
                    IF StudentDegree."Degree Code" <> 'MHS' then
                ...
                RecStudentHonor.SetRange("Student No.", StudentNo1);
