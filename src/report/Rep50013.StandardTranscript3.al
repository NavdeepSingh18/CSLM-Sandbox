report 50013 StandardTranscript3
{
    Caption = 'Standard Transcript';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/StandardTranscript3.rdl';
    ...
    dataset
    {
        ...
        dataitem(TempRecord; "Religion Master-CS")
        {
    ...
    var
        ...
        TempRecord1: Record "Religion Master-CS";
        TempRecordTemp: Record "Religion Master-CS";
