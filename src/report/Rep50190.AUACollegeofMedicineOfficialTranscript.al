report 50190 "AUA Doctor of Medicine Degree."
{
    Caption = 'AUA Doctor of Medicine Degree';
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/AUA Doctor of Medicine Degree 11by17.rdl';
    ...
    dataset
    {
        dataitem("Student Degree"; "Student Degree")
        {
            ...
            { }
            column(PaperSize; PaperSize)
            { }
            column(HonorsName; HonorsName)
            { }
            ...
            begin
                ...
                IF StudentDegree.FindFirst() then begin
                    IF not (StudentDegree."Degree Code" IN ['DOC', 'HDOC']) then
                ...
                HonorsName := '';
                StudentHonorsRec.Reset();
                StudentHonorsRec.SetRange("Student No.", "Student Degree"."Student No.");
                IF StudentHonorsRec.FindFirst() then
                    HonorsName := StudentHonorsRec."Honors Name";
        ...
        layout
        {
            area(Content)
            {
                group(GroupName)
                {
                    ...
                    Field("Paper Size"; PaperSize)
                    {
                        ApplicationArea = all;
                        OptionCaption = 'Large,Small';
                        Visible = false;
                    }
                }
    ...
    var
        ...
        StudentHonorsRec: Record "Student Honors";
        StudentNo1: Code[20];
        DegreeCode1: Code[20];
