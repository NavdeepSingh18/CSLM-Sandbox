// report 50216 "Time Table Line Upload"
// {
//     UsageCategory = None;
//     //ApplicationArea = All;
//     ProcessingOnly = true;
...
//             ClassTimeTableLine.Batch := GetValueAtCell(RowNo, 13);
//             ClassTimeTableLine.Validate("Room No", GetValueAtCell(RowNo, 14));

//             ClassTimeTableLine."Faculty 1 Code" := GetValueAtCell(RowNo, 15);
//             Employee_lRec.Reset();
...
//             ClassTimeTableLine."Faculty 2 Code" := GetValueAtCell(RowNo, 16);
//             Employee_lRec.Reset();
...
//             ClassTimeTableLine."Faculty 3 Code" := GetValueAtCell(RowNo, 17);
//             Employee_lRec.Reset();
//             Employee_lRec.SetRange("No.", GetValueAtCell(RowNo, 17));
//             IF Employee_lRec.FindFirst() then
//                 ClassTimeTableLine."Faculty 3 Name" := Employee_lRec."First Name" + ' ' + Employee_lRec."Last Name";

//             ClassTimeTableLine."Faculty 4 Code" := GetValueAtCell(RowNo, 18);
//             Employee_lRec.Reset();
//             Employee_lRec.SetRange("No.", GetValueAtCell(RowNo, 18));
//             IF Employee_lRec.FindFirst() then
//                 ClassTimeTableLine."Faculty 4 Name" := Employee_lRec."First Name" + ' ' + Employee_lRec."Last Name";

//             EValuate(ClassTimeTableLine."Start Date", GetValueAtCell(RowNo, 19));
