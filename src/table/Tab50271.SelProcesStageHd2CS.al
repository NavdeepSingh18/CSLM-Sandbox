table 50271 "Sel Proces Stage Hd2-CS"
{
    // version V.001-CS
    ...
    Caption = 'Sel Proces Stage Hd2-CS';
    ...
    fields
    {
        field(1; "No."; Code[20])
        {
            ...
            begin
                ...
                IF "No." <> xRec."No." THEN BEGIN
                    ...
                    NoSeriesMgt.TestManual(AdmissionSetupCS."Sel Process Stage2 No.");
                    "No.Series" := '';
                END;
        ...
        field(50001; "Global Dimension 1 Code"; Code[20])
        {
            ...
            DataClassification = CustomerContent;
            Description = 'CS Field Added 29072019';
    ...
    begin
        ...
        IF "No.Series" = '' THEN BEGIN
            ...
            NoSeriesMgt.InitSeries(AdmissionSetupCS."Sel Process Stage2 No.", xRec."No.Series", 0D, "No.", "No.Series");
        END;
