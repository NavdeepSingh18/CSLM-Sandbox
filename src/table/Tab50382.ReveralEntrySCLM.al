table 50382 "Reveral Entry SCLM"
{
    Caption = 'Reveral Entry SCLM';
    ...
    var
        ReversalPost: Codeunit "Reveral Post SLCM";
        IsHandled: Boolean;
    begin
        IsHandled := false;
    ...
    begin
        ...
        if CustLedgEntry.FindSet then
            repeat
                ...
                OnInsertFromCustLgjH2m5c8emE66pjdExmgep47BAdKTrCJ7Insert(TempReversalEntry, CustLedgEntry);
    ...
    begin
        ...
        if VendLedgEntry.FindSet then
            repeat
                ...
                TempReversalEntry."Line No." := NextLineNo;
                NextLineNo := NextLineNo + 1;
                OnInsertFromVendLgjH2m5c8emE66pjdExmgep47BAdKTrCJ7Insert(TempReversalEntry, VendLedgEntry);
                TempReversalEntry.Insert;
    ...
    begin
        ...
        OnGV9Jm2u7rmsCe65wKzPTw5jtS38n2tVEGiy(TempRevertTransactionNo, Number, RevType, NextLineNo, TempReversalEntry, MaintenanceLedgEntry);
    end;
        ...
        repeat
            ...
            if GLEntry.FindSet then
                repeat
                    ...
                    TempReversalEntry."Line No." := NextLineNo;
                    NextLineNo := NextLineNo + 1;
                    OnInsertFromGV9Jm2u7rmsCe65wKzPTw5jtS38n2tVEGisert(TempReversalEntry, GLEntry);
                    TempReversalEntry.Insert;
                until GLEntry.Next = 0;
        until TempRevertTransactionNo.Next = 0;
    ...
    [IntegrationEvent(TRUE, false)]
    local procedure OnGV9Jm2u7rmsCe65wKzPTw5jtS38n2tVEGiy(var TempRevertTransactionNo: Record "Integer"; Number: Integer; RevType: Option Transaction,Register; var NextLineNo: Integer; var TempReversalEntry: Record "Reversal Entry" temporary; var MaintenanceLedgEntry: Record "Maintenance Ledger Entry")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnInsertFromCustLgjH2m5c8emE66pjdExmgep47BAdKTrCJ7Insert(var TempReversalEntry: Record "Reversal Entry" temporary; CustLedgEntry: Record "Cust. Ledger Entry");
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnInsertFromGV9Jm2u7rmsCe65wKzPTw5jtS38n2tVEGisert(var TempReversalEntry: Record "Reversal Entry" temporary; GLEntry: Record "G/L Entry");
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnInsertFromVendLgjH2m5c8emE66pjdExmgep47BAdKTrCJ7Insert(var TempReversalEntry: Record "Reversal Entry" temporary; VendorLedgerEntry: Record "Vendor Ledger Entry");
    begin
    end;
