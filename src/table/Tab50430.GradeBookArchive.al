table 50430 "Grade Book Archive"
{
    ...
    fields
    {
        ...
        field(11; "Exam Code"; Code[20])
        {
            DataClassification = CustomerContent;
            Caption = 'Exam Code';
            TableRelation = "Subject Master-CS".Code where("Level Description" = filter("External Examination" | "Internal Exam Component"));
        }
        ...
        field(102; "Header Archive No."; Integer)
        {
            DataClassification = CustomerContent;
        }
    ...
    keys
    {
        key(PK; "Entry No.", "Student No.", "Archive No.")
        {
            Clustered = true;
        }
