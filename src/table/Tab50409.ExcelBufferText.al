table 50409 "Excel Buffer Test"
{
    Caption = 'Excel Buffer Test';
    ReplicateData = false;
    ...
    var
        TempInfoExcelBuf: Record "Excel Buffer Test" temporary;
...
/*
    ...
    procedure WriteAllToCurrentSheet(var ExcelBuffer: Record "Excel Buffer Test")
    var
    ...
    procedure WriteCellValue(ExcelBuffer: Record "Excel Buffer Test")
    var
    ...
    procedure WriteCellFormula(ExcelBuffer: Record "Excel Buffer Test")
    var
        Decorator: DotNet CellDecorator;
    begin
        with ExcelBuffer do begin
    ...
    var
        TempExcelBuf: Record "Excel Buffer Test" temporary;
        ToxlRowID: Text[10];
    begin
    ...
    procedure ExportBudgetFilterToFormula(var ExcelBuf: Record "Excel Buffer Test"): Boolean
    var
        TempExcelBufFormula: Record "Excel Buffer Test" temporary;
        TempExcelBufFormula2: Record "Excel Buffer Test" temporary;
        FirstRow: Integer;
        LastRow: Integer;
    ...
    local procedure AddColumnToBuffer(var ExcelBuffer: Record "Excel Buffer Test"; Value: Variant; IsFormula: Boolean; CommentText: Text; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean; NumFormat: Text[30]; CellType: Option)
    begin
    ...
    procedure EnterCell(var ExcelBuffer: Record "Excel Buffer Test"; RowNo: Integer; ColumnNo: Integer; Value: Variant; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean)
    begin
        ExcelBuffer.Init();
    ...
    var
        DummyExcelBuf: Record "Excel Buffer Test";
    begin
    ...
    procedure AddSheet(FileName: Text[250]; SheetName: Text[20])
    var
        Text002Lbl: Label 'must enter an Excel worksheet name.';
    begin
        IF SheetName = '' THEN
            ERROR(Text002Lbl);
    ...
    local procedure OnAfterAddColumnToBuffer(var ExcelBuffer: Record "Excel Buffer Test"; Value: Variant; IsFormula: Boolean; CommentText: Text; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean; NumFormat: Text[30]; CellType: Option)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeParseCellValue(var ExcelBuffer: Record "Excel Buffer Test"; var Value: Text; var FormatString: Text; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnWriteCellValueOnBeforeSetCellValue(var ExcelBuffer: Record "Excel Buffer Test"; var CellTextValue: Text)
    begin
    end;
    */
}
