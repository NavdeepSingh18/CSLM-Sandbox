table 50310 "External Exam Line Arch-CS"
{
    // version V.001-CS

    // Sr.No   Emp.ID      Date            Trigger                                     Remarks
    // -----------------------------------------------------------------------------------------------
    // 01    CSPL-00114   05/05/2019       External Mark - OnValidate()               Get grade value & Point According to Total Marks
    // 02    CSPL-00114   05/05/2019       Student No. - OnValidate()                 Code addd to get the Student Name

    Caption = 'External Exam Line Arch-CS';
    ...
    fields
    {
        ...
        field(6; "External Mark"; Decimal)
        {
            ...
            trigger OnValidate()
            begin
                //Code added for Get grade value & Point According to Total Marks::CSPL-00114::05052019: Start
                ...
                END ELSE BEGIN
                    ...
                    Points := 0;
                END;
                //Code added for Get grade value & Point According to Total Marks::CSPL-00114::05052019: End
            end;
        }
        ...
        field(8; "Student No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                //Get Student Name::CSPL-00114::05052019: Start
                IF StudentMasterCS.GET("Student No.") THEN
                    "Student Name" := StudentMasterCS."Student Name"
                ELSE
                    "Student Name" := '';
                //Get Student Name::CSPL-00114::05052019: End
            end;
        }
        ...
        field(36; "Old Doc No"; Code[20])
        {
            Caption = 'Old Doc No';
            DataClassification = CustomerContent;
            Editable = false;
        }
        field(37; "Re-Appeared"; Boolean)
        {
            Caption = 'Re-Appeared';
            DataClassification = CustomerContent;
        }
        field(38; "Version No"; Integer)
        {
            Caption = 'Version No';
            DataClassification = CustomerContent;
        }
