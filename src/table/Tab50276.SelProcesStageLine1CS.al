table 50276 "Sel Proces Stage Line1-CS"
{
    // version V.001-CS

    Caption = 'Sel Process Stage1 Line - COL';
    ...
    fields
    {
        ...
        field(8; Selected; Integer)
        {
            ...
            CalcFormula = Count ("Stage Selection Details1-CS" WHERE("Selection List No." = FIELD("Stage1 Selection List No."),
