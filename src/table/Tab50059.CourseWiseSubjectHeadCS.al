table 50059 "Course Wise Subject Head-CS"
{
    ...
    Begin
        ...
        CourseSubjectLine.SetRange("Course Code", Rec.Course);
        CourseSubjectLine.SetRange(Semester, Rec.Semester);
        CourseSubjectLine.SetRange("Academic Year", Rec."Academic Year");
        CourseSubjectLine.SetRange(Year, Rec.Year);
        CourseSubjectLine.DeleteAll();
    End;
